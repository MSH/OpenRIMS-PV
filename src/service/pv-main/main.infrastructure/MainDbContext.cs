...
using OpenRIMS.PV.Main.Infrastructure.EntityConfigurations;
using OpenRIMS.PV.Main.Infrastructure.EntityConfigurations.KeyLess;
using OpenRIMS.PV.Main.Infrastructure.Helpers;
using System;
using System.Data;
using System.Linq;
...
namespace OpenRIMS.PV.Main.Infrastructure
{
    public class MainDbContext : DbContext
    {
        ...
        public virtual DbSet<MetaFormCategory> MetaFormCategories { get; set; }
        public virtual DbSet<MetaFormCategoryAttribute> MetaFormCategoryAttributes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new MetaFormCategoryAttributeEntityTypeConfiguration());
            modelBuilder.ApplyConfiguration(new MetaFormCategoryEntityTypeConfiguration());
