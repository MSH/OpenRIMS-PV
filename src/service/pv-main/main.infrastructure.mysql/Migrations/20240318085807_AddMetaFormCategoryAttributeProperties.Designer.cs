...
namespace OpenRIMS.PV.Main.Infrastructure.MySQL.Migrations
{
    ...
    [Migration("20240318085807_AddMetaFormCategoryAttributeProperties")]
    partial class AddMetaFormCategoryAttributeProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Aggregates.MetaFormAggregate.MetaForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Aggregates.MetaFormAggregate.MetaFormCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<Guid>("MetaFormCategoryGuid")
                        .HasColumnType("char(36)")
                        .HasColumnName("metaformcategory_guid");

                    b.Property<int>("MetaFormId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("MetaFormId");

                    b.HasIndex("MetaTableId");

                    b.ToTable("MetaFormCategory", (string)null);
                });

            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Aggregates.MetaFormAggregate.MetaFormCategoryAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CustomAttributeConfigurationId")
                        .HasColumnType("int")
                    ...
                    b.Property<Guid>("MetaFormCategoryAttributeGuid")
                        .HasColumnType("char(36)")
                    ...
                    b.HasIndex("CustomAttributeConfigurationId");

                    b.HasIndex("MetaFormCategoryId");

                    b.ToTable("MetaFormCategoryAttribute", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.AdverseEventList", b =>
                {
                    ...
                    b.ToView("vwAdverseEventList", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.ContingencyAnalysisItem", b =>
                {
                    ...
                    b.ToView("vwContingencyAnalysisItem", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.ContingencyAnalysisList", b =>
                {
                    ...
                    b.ToView("vwContingencyAnalysisList", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.ContingencyAnalysisPatient", b =>
                {
                    ...
                    b.ToView("vwContingencyAnalysisPatient", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.DrugList", b =>
                {
                    ...
                    b.ToView("vwDrugList", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.MetaPatientList", b =>
                {
                    ...
                    b.ToView("vwMetaPatientList", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.PatientIdList", b =>
                {
                    ...
                    b.ToView("vwPatientIdList", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Entities.Keyless.PatientOnStudyList", b =>
                {
                    ...
                    b.ToView("vwPatientOnStudyVisitList", (string)null);
                });
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Aggregates.MetaFormAggregate.MetaFormCategory", b =>
                {
                    b.HasOne("OpenRIMS.PV.Main.Core.Aggregates.MetaFormAggregate.MetaForm", "MetaForm")
                        .WithMany("Categories")
                        .HasForeignKey("MetaFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpenRIMS.PV.Main.Core.Entities.MetaTable", "MetaTable")
                        .WithMany()
                        .HasForeignKey("MetaTableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MetaForm");
            ...
            modelBuilder.Entity("OpenRIMS.PV.Main.Core.Aggregates.MetaFormAggregate.MetaFormCategoryAttribute", b =>
                {
                    b.HasOne("OpenRIMS.PV.Main.Core.Entities.CustomAttributeConfiguration", "CustomAttributeConfiguration")
                        .WithMany()
                        .HasForeignKey("CustomAttributeConfigurationId");

                    b.HasOne("OpenRIMS.PV.Main.Core.Aggregates.MetaFormAggregate.MetaFormCategory", "MetaFormCategory")
                        .WithMany("Attributes")
                        .HasForeignKey("MetaFormCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CustomAttributeConfiguration");

                    b.Navigation("MetaFormCategory");
                });
