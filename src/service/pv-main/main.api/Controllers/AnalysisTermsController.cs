...
namespace OpenRIMS.PV.Main.API.Controllers
{
    ...
    public class AnalysisTermsController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [Produces("application/vnd.main.analyserpatientset.v1+json", "application/vnd.main.analyserpatientset.v1+xml")]
        [RequestHeaderMatchesMediaType("Accept",
            "application/vnd.main.analyserpatientset.v1+json", "application/vnd.main.analyserpatientset.v1+xml")]
