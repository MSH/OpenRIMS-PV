...
namespace OpenRIMS.PV.Main.API.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        [Produces("application/vnd.main.search.v1+json", "application/vnd.main.search.v1+xml")]
        [RequestHeaderMatchesMediaType("Accept",
            "application/vnd.main.search.v1+json", "application/vnd.main.search.v1+xml")]
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [Produces("application/vnd.main.outstandingvisitreport.v1+json", "application/vnd.main.outstandingvisitreport.v1+xml")]
        [RequestHeaderMatchesMediaType("Accept",
            "application/vnd.main.outstandingvisitreport.v1+json", "application/vnd.main.outstandingvisitreport.v1+xml")]
        [ApiExplorerSettings(IgnoreApi = true)]
