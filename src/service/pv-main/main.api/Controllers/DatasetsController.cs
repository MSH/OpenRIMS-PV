...
using OpenRIMS.PV.Main.API.Application.Queries.DatasetAggregate;
...
namespace OpenRIMS.PV.Main.API.Controllers
{
    ...
    public class DatasetsController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [Produces("application/vnd.main.spontaneousdataset.v1+json", "application/vnd.main.spontaneousdataset.v1+xml")]
        [RequestHeaderMatchesMediaType("Accept",
            "application/vnd.main.spontaneousdataset.v1+json", "application/vnd.main.spontaneousdataset.v1+xml")]
        [ApiExplorerSettings(IgnoreApi = true)]
