...
{
    public class AddMetaFormCategoryCommandValidator : AbstractValidator<AddMetaFormCategoryCommand>
    {
        public AddMetaFormCategoryCommandValidator(ILogger<AddMetaFormCategoryCommandValidator> logger)
        {
