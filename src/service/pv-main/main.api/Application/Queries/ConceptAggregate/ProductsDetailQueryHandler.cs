...
{
    public class ProductsDetailQueryHandler
        : IRequestHandler<ProductsDetailQuery, LinkedCollectionResourceWrapperDto<ProductDetailDto>>
    {
        private readonly IRepositoryInt<Product> _productRepository;
        private readonly ILinkGeneratorService _linkGeneratorService;
        private readonly IMapper _mapper;
        private readonly ILogger<ProductsDetailQueryHandler> _logger;

        public ProductsDetailQueryHandler(
            IRepositoryInt<Product> productRepository,
            ILinkGeneratorService linkGeneratorService,
            IMapper mapper,
            ILogger<ProductsDetailQueryHandler> logger)
        {
