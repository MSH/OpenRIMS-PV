...
{
    public class ChangeCohortGroupDetailsCommandValidator : AbstractValidator<ChangeCohortGroupDetailsCommand>
    {
        public ChangeCohortGroupDetailsCommandValidator(ILogger<ChangeCohortGroupDetailsCommandValidator> logger)
        {
