...
{
    public class ConceptsIdentifierQueryHandler
        : IRequestHandler<ConceptsIdentifierQuery, LinkedCollectionResourceWrapperDto<ConceptIdentifierDto>>
    {
        private readonly IRepositoryInt<Concept> _conceptRepository;
        private readonly ILinkGeneratorService _linkGeneratorService;
        private readonly IMapper _mapper;
        private readonly ILogger<ConceptsIdentifierQueryHandler> _logger;

        public ConceptsIdentifierQueryHandler(
            IRepositoryInt<Concept> conceptRepository,
            ILinkGeneratorService linkGeneratorService,
            IMapper mapper,
            ILogger<ConceptsIdentifierQueryHandler> logger)
        {
        ...
        public async Task<LinkedCollectionResourceWrapperDto<ConceptIdentifierDto>> Handle(ConceptsIdentifierQuery message, CancellationToken cancellationToken)
        {
            ...
            if (pagedConceptsFromRepo != null)
            {
                ...
                var mappedConcepts = PagedCollection<ConceptIdentifierDto>.Create(_mapper.Map<PagedCollection<ConceptIdentifierDto>>(pagedConceptsFromRepo),
                ...
                var wrapper = new LinkedCollectionResourceWrapperDto<ConceptIdentifierDto>(pagedConceptsFromRepo.TotalCount, mappedConcepts, pagedConceptsFromRepo.TotalPages);
        ...
        private void CreateLinks(ConceptIdentifierDto mappedConcept)
        {
