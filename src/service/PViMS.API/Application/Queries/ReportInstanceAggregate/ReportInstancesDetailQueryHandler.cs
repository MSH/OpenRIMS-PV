...
{
    public class ReportInstancesDetailQueryHandler
        : IRequestHandler<ReportInstancesDetailQuery, LinkedCollectionResourceWrapperDto<ReportInstanceDetailDto>>
    {
        ...
        private readonly ILogger<ReportInstancesDetailQueryHandler> _logger;

        public ReportInstancesDetailQueryHandler(
            ...
            IMapper mapper,
            ILogger<ReportInstancesDetailQueryHandler> logger)
        {
        ...
        public async Task<LinkedCollectionResourceWrapperDto<ReportInstanceDetailDto>> Handle(ReportInstancesDetailQuery message, CancellationToken cancellationToken)
        {
