...
export class ConditionService extends BaseService {
    ...
    return this.getConditionsByDetail(filter)
      .pipe( 
        expand(response => {
          ...
          return next ? this.GetByAddress<ConditionDetailWrapperModel>(next.href, 'application/vnd.pvims.detail.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as ConditionDetailWrapperModel;
  ...
  getConditions(filterModel: any): any {
    ...
    return this.Get<ConditionIdentifierWrapperModel>('', 'application/vnd.pvims.identifier.v1+json', parameters);
  }
  ...
  getConditionsByDetail(filterModel: any): any {
    ...
    return this.Get<ConditionDetailWrapperModel>('', 'application/vnd.pvims.detail.v1+json', parameters);
  }
    ...
    return this.getOutcomes(filter)
      .pipe( 
        expand(response => {
          ...
          let next = typedResponse.links.find(l => l.rel == 'nextPage');
          return next ? this.GetByAddress<OutcomeIdentifierWrapperModel>(next.href, 'application/vnd.pvims.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as OutcomeIdentifierWrapperModel;
          return typedResponse.value;
  ...
  getOutcomes(filterModel: any): any {
    ...
    return this.Get<OutcomeIdentifierWrapperModel>('/outcomes', 'application/vnd.pvims.identifier.v1+json', parameters);
  }
    ...
    return this.getTreatmentOutcomes(filter)
      .pipe( 
        expand(response => {
          ...
          let next = typedResponse.links.find(l => l.rel == 'nextPage');
          return next ? this.GetByAddress<TreatmentOutcomeIdentifierWrapperModel>(next.href, 'application/vnd.pvims.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as TreatmentOutcomeIdentifierWrapperModel;
          return typedResponse.value;
  ...
  getTreatmentOutcomes(filterModel: any): any {
    ...
    return this.Get<TreatmentOutcomeIdentifierWrapperModel>('/treatmentoutcomes', 'application/vnd.pvims.identifier.v1+json', parameters);
  }
  ...
  getConditionDetail(id: number): any {
    ...
    return this.Get<ConditionDetailModel>('/conditions', 'application/vnd.pvims.detail.v1+json', parameters);
  }
