...
export class CohortGroupService extends BaseService {
  ...
  getCohortGroups(filterModel: any): any {
    ...
    return this.Get<CohortGroupIdentifierWrapperModel>('', 'application/vnd.pvims.identifier.v1+json', parameters);
  }
  ...
  getCohortGroupsByDetail(filterModel: any): any {
      ...
      return this.Get<CohortGroupDetailWrapperModel>('', 'application/vnd.pvims.detail.v1+json', parameters);
  }
  ...
  getCohortGroupEnrolmentsByDetail(cohortGroupId: number, filterModel: any): any {
    ...
    return this.Get<CohortGroupDetailWrapperModel>(`/cohortgroups/${cohortGroupId}/cohortgroupenrolments`, 'application/vnd.pvims.detail.v1+json', parameters);
  }
  ...
  getCohortGroupDetail(id: number): any {
    ...
    return this.Get<CohortGroupDetailModel>('', 'application/vnd.pvims.detail.v1+json', parameters);
  }
