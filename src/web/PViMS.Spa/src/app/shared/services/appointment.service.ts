...
export class AppointmentService extends BaseService {
    ...
    searchAppointment(filterModel: any): any {
      ...
      return this.Get<AppointmentSearchWrapperModel>('/appointments', 'application/vnd.pvims.search.v1+json', parameters);
    }
    ...
    getAppointmentDetail(patientId: number, id: number): any {
      ...
      return this.Get<AppointmentDetailModel>(`/patients/${patientId}/appointments`, 'application/vnd.pvims.detail.v1+json', parameters);
    }     
    ...
    getOutstandingVisitReport(filterModel: any): any {
      ...
      return this.Get<OutstandingVisitReportWrapperModel>('/appointments', 'application/vnd.pvims.outstandingvisitreport.v1+json', parameters);
    }    
}
