...
@Component({
  templateUrl: './form-b-labs.popup.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: egretAnimations
})
export class FormBLabsPopupComponent implements OnInit {
  
  public itemForm: FormGroup;
  protected busy: boolean = false;

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: FormBLabsPopupData,
    public dialogRef: MatDialogRef<FormBLabsPopupComponent>,
...
export interface FormBLabsPopupData {
  title: string;
  payload: any;
}