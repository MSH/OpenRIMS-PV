...
@Component({
  templateUrl: './form-a-medications.popup.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: egretAnimations
})
export class FormAMedicationsPopupComponent implements OnInit {
  
  public itemForm: FormGroup;
  protected busy: boolean = false;

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: FormAMedicationsPopupData,
    public dialogRef: MatDialogRef<FormAMedicationsPopupComponent>,
...
export interface FormAMedicationsPopupData {
  title: string;
  payload: any;
}