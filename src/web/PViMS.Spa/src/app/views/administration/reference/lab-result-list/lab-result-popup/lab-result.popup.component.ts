...
@Component({
  templateUrl: './lab-result.popup.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: egretAnimations
})
export class LabResultPopupComponent extends BasePopupComponent implements OnInit, AfterViewInit {
  
  public itemForm: FormGroup;

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: LabResultPopupData,
    public dialogRef: MatDialogRef<LabResultPopupComponent>,
