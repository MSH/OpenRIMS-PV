...
@Component({
  selector: 'labresultdelete-popup',
  templateUrl: './lab-result-delete.popup.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: egretAnimations
})
export class LabResultDeletePopupComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LabResultDeletePopupComponent>,
