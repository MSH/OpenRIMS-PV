...
@Component({
  templateUrl: './custom-attribute-add.popup.component.html',
  animations: egretAnimations
})
export class CustomAttributeAddPopupComponent extends BasePopupComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CustomAttributeAddPopupComponent>,
