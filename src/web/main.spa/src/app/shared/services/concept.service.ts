...
export class ConceptService extends BaseService {
    ...
    return this.getProducts(filter)
      .pipe( 
        expand(response => {
          ...
          return next ? this.GetByAddress<ProductIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as ProductIdentifierWrapperModel;
  ...
  getProducts(filterModel: any): any {
      ...
      return this.Get<ProductIdentifierWrapperModel>('/products', 'application/vnd.main.identifier.v1+json', parameters);
  }
    ...
    return this.getConcepts(filter)
      .pipe( 
        expand(response => {
          ...
          let next = typedResponse.links.find(l => l.rel == 'nextPage');
          return next ? this.GetByAddress<ConceptIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as ConceptIdentifierWrapperModel;
          return typedResponse.value;
  ...
  getConcepts(filterModel: any): any {
      ...
      return this.Get<ConceptIdentifierWrapperModel>('/concepts', 'application/vnd.main.identifier.v1+json', parameters);
  }
  ...
  searchConceptsByDetail(filterModel: any): any {
    ...
    return this.Get<ConceptDetailWrapperModel>('/concepts', 'application/vnd.main.detail.v1+json', parameters);
  }
  ...
  searchProductsByDetail(filterModel: any): any {
    ...
    return this.Get<ProductDetailWrapperModel>('/products', 'application/vnd.main.detail.v1+json', parameters);
  }
    ...
    return this.getMedicationForms(filter)
      .pipe( 
        expand(response => {
          ...
          let next = typedResponse.links.find(l => l.rel == 'nextPage');
          return next ? this.GetByAddress<MedicationFormIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as MedicationFormIdentifierWrapperModel;
          return typedResponse.value;
  ...
  getMedicationForms(filterModel: any): any {
      ...
      return this.Get<MedicationFormIdentifierWrapperModel>('/medicationforms', 'application/vnd.main.identifier.v1+json', parameters);
  }
