...
export class HolidayService extends BaseService {
  ...
  getHolidays(filterModel: any): any {
    ...
    return this.Get<HolidayIdentifierWrapperModel>('/holidays', 'application/vnd.main.identifier.v1+json', parameters);
}  
  ...
  getHolidayIdentifier(id: number): any {
    ...
    return this.Get<HolidayIdentifierModel>('/holidays', 'application/vnd.main.identifier.v1+json', parameters);
  }     
