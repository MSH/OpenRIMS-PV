...
export class FacilityService extends BaseService {
      ...
      return this.getFacilities(filter)
        .pipe( 
          expand(response => {
            ...
            return next ? this.GetByAddress<FacilityDetailWrapperModel>(next.href, 'application/vnd.main.detail.v1+json') : EMPTY;
          }),
          map(response => {
            let typedResponse = response as FacilityDetailWrapperModel;
    ...
    getFacilityTypeList(): any {
      ...
      return this.Get<FacilityTypeIdentifierWrapperModel>('/facilitytypes', 'application/vnd.main.identifier.v1+json', parameters);
    }     
    ...
    getFacilities(filterModel: any): any {
      ...
      return this.Get<FacilityDetailWrapperModel>('/facilities', 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getFacilityDetail(id: number): any {
      ...
      return this.Get<FacilityDetailModel>('/facilities', 'application/vnd.main.detail.v1+json', parameters);
    }     
