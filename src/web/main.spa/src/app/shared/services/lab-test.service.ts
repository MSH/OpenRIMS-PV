...
export class LabTestService extends BaseService {
    ...
    return this.getLabTests(filter)
      .pipe( 
        expand(response => {
          ...
          return next ? this.GetByAddress<LabTestIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as LabTestIdentifierWrapperModel;
  ...
  getLabTests(filterModel: any): any {
      ...
      return this.Get<LabTestIdentifierWrapperModel>('/labtests', 'application/vnd.main.identifier.v1+json', parameters);
  }
    ...
    return this.getLabResults(filter)
      .pipe( 
        expand(response => {
          ...
          let next = typedResponse.links.find(l => l.rel == 'nextPage');
          return next ? this.GetByAddress<LabResultIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as LabResultIdentifierWrapperModel;
          return typedResponse.value;
  ...
  getLabResults(filterModel: any): any {
    ...
    return this.Get<LabResultIdentifierWrapperModel>('/labresults', 'application/vnd.main.identifier.v1+json', parameters);
  }
    ...
    return this.getLabTestUnits(filter)
      .pipe( 
        expand(response => {
          ...
          let next = typedResponse.links.find(l => l.rel == 'nextPage');
          return next ? this.GetByAddress<LabTestUnitIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as LabTestUnitIdentifierWrapperModel;
          return typedResponse.value;
  ...
  getLabTestUnits(filterModel: any): any {
      ...
      return this.Get<LabTestUnitIdentifierWrapperModel>('/labtestunits', 'application/vnd.main.identifier.v1+json', parameters);
  }
  ...
  getLabTestIdentifier(id: number): any {
    ...
    return this.Get<LabTestIdentifierModel>('/labtests', 'application/vnd.main.identifier.v1+json', parameters);
  }
  ...
  getLabResultIdentifier(id: number): any {
    ...
    return this.Get<LabResultIdentifierModel>('/labresults', 'application/vnd.main.identifier.v1+json', parameters);
  }     
