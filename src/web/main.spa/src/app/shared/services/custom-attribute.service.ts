...
export class CustomAttributeService extends BaseService {
    ...
    getPatientCustomAttributeSearchableList(): any {
        ...
        return this.Get<CustomAttributeIdentifierWrapperModel>('', 'application/vnd.main.identifier.v1+json', parameters);
    }
      ...
      return this.getCustomAttributes(extendableTypeName, filter)
        .pipe( 
          expand(response => {
            ...
            return next ? this.GetByAddress<CustomAttributeDetailWrapperModel>(next.href, 'application/vnd.main.detail.v1+json') : EMPTY;
          }),
          map(response => {
            let typedResponse = response as CustomAttributeDetailWrapperModel;
    ...
    getCustomAttributes(extendableTypeName: string, filterModel: any): any {
      ...
      return this.Get<CustomAttributeDetailWrapperModel>('', 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getCustomAttributeDetail(id: number): any {
      ...
      return this.Get<CustomAttributeDetailModel>('', 'application/vnd.main.detail.v1+json', parameters);
    }    
