...
export class EncounterService extends BaseService {
    ...
    searchEncounter(filterModel: any): any {
        ...
        return this.Get<EncounterDetailWrapperModel>('/encounters', 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getEncounterExpanded(patientId: number, id: number): any {
        ...
        return this.Get<EncounterExpandedModel>(`/patients/${patientId}/encounters`, 'application/vnd.main.expanded.v1+json', parameters);
    }
    ...
    getEncounterDetail(patientId: number, id: number): any {
      ...
      return this.Get<EncounterDetailModel>(`/patients/${patientId}/encounters`, 'application/vnd.main.detail.v1+json', parameters);
    } 
