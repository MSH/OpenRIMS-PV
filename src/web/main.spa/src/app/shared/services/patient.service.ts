...
export class PatientService extends BaseService {
    ...
    searchPatient(filterModel: any): any {
      ...
      return this.Get<PatientDetailWrapperModel>('', 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getPatientByCondition(filterModel: any): any {
      ...
      return this.Get<PatientExpandedModel>('', 'application/vnd.main.expanded.v1+json', parameters);
    }    
    ...
    getPatientDetail(id: number): any {
      ...
      return this.Get<PatientDetailModel>('', 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getPatientConditionDetail(patientId: number, id: number): any {
      ...
      return this.Get<PatientConditionDetailModel>(`/patients/${patientId}/conditions`, 'application/vnd.main.detail.v1+json', parameters);
    } 
    ...
    getPatientClinicalEventDetail(patientId: number, id: number): any {
      ...
      return this.Get<PatientClinicalEventDetailModel>(`/patients/${patientId}/clinicalevents`, 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getPatientClinicalEventExpanded(patientId: number, id: number): any {
      ...
      return this.Get<PatientClinicalEventExpandedModel>(`/patients/${patientId}/clinicalevents`, 'application/vnd.main.expanded.v1+json', parameters);
    }
    ...
    getPatientMedicationDetail(patientId: number, id: number): any {
      ...
      return this.Get<PatientClinicalEventDetailModel>(`/patients/${patientId}/medications`, 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getPatientLabTestDetail(patientId: number, id: number): any {
      ...
      return this.Get<PatientLabTestDetailModel>(`/patients/${patientId}/labtests`, 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    getAdverseEventReport(filterModel: any): any {
        ...
        return this.Get<AdverseEventReportWrapperModel>('/patients', 'application/vnd.main.adverseventreport.v1+json', parameters);
    }    
    ...
    getAdverseEventFrequencyReport(filterModel: any): any {
        ...
        return this.Get<AdverseEventFrequencyReportWrapperModel>('/patients', 'application/vnd.main.adverseventfrequencyreport.v1+json', parameters);
    }    
    ...
    getPatientTreatmentReport(filterModel: any): any {
        ...
        return this.Get<PatientTreatmentReportWrapperModel>('/patients', 'application/vnd.main.patienttreatmentreport.v1+json', parameters);
    }
    ...
    getPatientMedicationReport(filterModel: any): any {
      ...
      return this.Get<PatientMedicationReportWrapperModel>('/patients', 'application/vnd.main.patientmedicationreport.v1+json', parameters);
    }
    ...
    downloadAttachment(patientId: number, id: number): any {
      ...
      return this.Download(`/patients/${patientId}/attachments`, 'application/vnd.main.attachment.v1+xml', parameters);
    }
