...
export class MeddraTermService extends BaseService {
      ...
      return this.searchTerms(filterModel)
        .pipe( 
          expand(response => {
            ...
            return next ? this.GetByAddress<MeddraTermIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
          }),
          map(response => {
            let typedResponse = response as MeddraTermIdentifierWrapperModel;
    ...
    getCommonTerms(filterModel: any): any {
      ...
      return this.Get<MeddraTermIdentifierWrapperModel>('', 'application/vnd.main.commonmeddra.v1+json', parameters);
    }
    ...
    getMeddraTermDetail(id: number): any {
      ...
      return this.Get<MeddraTermDetailModel>('', 'application/vnd.main.detail.v1+json', parameters);
    }
    ...
    searchTerms(filterModel: any): any {
        ...
        return this.Get<MeddraTermIdentifierWrapperModel>('', 'application/vnd.main.identifier.v1+json', parameters);
    }
    ...
    searchTermsByDetail(filterModel: any): any {
      ...
      return this.Get<MeddraTermDetailWrapperModel>('', 'application/vnd.main.detail.v1+json', parameters);
    }
