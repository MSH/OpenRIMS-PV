...
export class UserService extends BaseService {
    ...
    return this.getAuditLogs(filterModel)
      .pipe( 
        expand(response => {
          ...
          return next ? this.GetByAddress<AuditLogDetailWrapperModel>(next.href, 'application/vnd.main.detail.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as AuditLogDetailWrapperModel;
  ...
  getAuditLogs(filterModel: any): any {
    ...
    return this.Get<AuditLogDetailWrapperModel>('/auditlogs', 'application/vnd.main.detail.v1+json', parameters);
  }
  ...
  downloadAuditLogDataset(filterModel: any): any {
    ...
    return this.Download('/auditlogs', 'application/vnd.main.dataset.v1+json', parameters);
  }
  ...
  getRoleList(): any {
    ...
    return this.Get<RoleIdentifierWrapperModel>('/roles', 'application/vnd.main.identifier.v1+json', parameters);
  }
    ...
    return this.getUsers(filter)
      .pipe( 
        expand(response => {
          ...
          let next = typedResponse.links.find(l => l.rel == 'nextPage');
          return next ? this.GetByAddress<UserIdentifierWrapperModel>(next.href, 'application/vnd.main.identifier.v1+json') : EMPTY;
        }),
        map(response => {
          let typedResponse = response as UserIdentifierWrapperModel;
          return typedResponse.value;
  ...
  getUsers(filterModel: any): any {
    ...
    return this.Get<UserIdentifierWrapperModel>('/users', 'application/vnd.main.identifier.v1+json', parameters);
  }
  ...
  getUserDetail(id: number): any {
    ...
    return this.Get<UserDetailModel>('/users', 'application/vnd.main.detail.v1+json', parameters);
  }  
  ...
  downloadAuditLog(id: number): any {
    ...
    return this.Download('/auditlogs', 'application/vnd.main.auditlog.v1+xml', parameters);
  }
