...
@Component({
  templateUrl: './widget-configure.popup.component.html',
  styleUrls: ['./widget-configure.popup.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: egretAnimations
})
export class WidgetConfigurePopupComponent extends BasePopupComponent implements OnInit, AfterViewInit {
  
  public itemForm: FormGroup;

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: WidgetConfigurePopupData,
    public dialogRef: MatDialogRef<WidgetConfigurePopupComponent>,
